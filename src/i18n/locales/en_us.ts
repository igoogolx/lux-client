...
export default {
  ...
  [TRANSLATION_KEY.DISABLE_RESUE]: "Disable Resue",
  [TRANSLATION_KEY.ECH_OPTS]: "ECH Opts",
  [TRANSLATION_KEY.ENABLE]: "Enable",
  ...
  [TRANSLATION_KEY.FORM_UDP_OVER_TCP_VERSION]: "UDP Over TCP Version",
  [TRANSLATION_KEY.FORM_PLUGIN_OPTS]: "Plugin Opts",
  ...
  [TRANSLATION_KEY.NEW_ANYTLS]: "Create AnyTLS",
  ...
  [TRANSLATION_KEY.IMPORT_PROXY_URI]: "Import Proxy URI",
  [TRANSLATION_KEY.IMPORT_PROXY_FROM_CLASH_YAML]:
    "Import Proxy From Clash YAML",
  ...
  [TRANSLATION_KEY.EDIT_ANYTLS]: "Edit AnyTLS",
